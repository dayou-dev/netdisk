...
class AppTemplate
{
    ...
    var $_var           = array();
    var $_hash        = '554fcae493e564ee0dc75bdf2ebf94cb';
    var $_foreach       = array();
    var $_current_file  = '';
    var $_expires       = 0;
    var $_errorlevel    = 0;
    ...
    function display($filename, $cache_id = '')
    {
		...
		if($http_type=='https://'){
			$out = str_replace("http://".$_SERVER['HTTP_HOST'],"https://".$_SERVER['HTTP_HOST'],$out);
			//$out = str_replace("https://www.w3.org","http://www.w3.org",$out);
		}
    ...
    function fetch_str($source)
    {
		...
		//$out = "<?php \n" . '$k = ' . preg_replace_callback("/(\'\\$[^,]+)/" , function($r) { return stripslashes(trim('\\1','\'')); }, var_export($t, true)) . ";\n";
    }
