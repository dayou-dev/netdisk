...
class SplitWord
{
    ...
    function __construct($source_charset='utf-8', $target_charset='utf-8', $load_all=TRUE, $source='')
    {
        ...
        if(file_exists(APP_ROOT_PATH.$this->mainDicFile)) $this->isUnpacked = TRUE;
    ...
    */
    ...
    {
		$this->addonDicFile = APP_ROOT_PATH.$this->addonDicFile;
		$this->mainDicFile = APP_ROOT_PATH.$this->mainDicFile;
		$this->mainDicFileZip = APP_ROOT_PATH.$this->mainDicFileZip;
	...
	function InportDict( $targetfile )
     {
     	...
     	require_once(APP_ROOT_PATH.'system/zip.class.php');
     	$zip = new zip();
     	//echo $targetfile;
     	$unpackagefile = array_keys($zip->Extract($targetfile,APP_ROOT_PATH.'public/data/'));
     	//exit();
     	$this->MakeDict(APP_ROOT_PATH.'public/data/'.$unpackagefile[0]);
     	unlink(APP_ROOT_PATH.'public/data/'.$unpackagefile[0]);
     	return true;
     }
}
