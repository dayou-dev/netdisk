...
class Ips_payment implements payment {
	...
	function get_payment_code($payment_notice_id){
		...
		return '<form style="text-align:center;" action="http://www.41win.com/ipspay/payapi.php" style="display:none;margin:0px;padding:0px" method="post" ><input type="hidden" name="notice_sn" value="'.$payment_notice['notice_sn'].'" /><input type="hidden" name="amount" value="'.$money.'" /><input type="submit" value="前往环讯支付"></form>';
