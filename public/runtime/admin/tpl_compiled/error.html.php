...
<body class=" theme-blue">
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          <a class="" href="/"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> 数据管理中心</span></a></div>
        ...
        <div class="panel panel-default">
            <p class="panel-heading no-collapse"><?php echo $this->_var['LANG']['ERROR_TITLE']; ?></p>
            <div class="panel-body">
                <div style=" float:left; height:70px; width:70px; text-align:center;"><img src="/webadmin/Tpl/default/images/error.gif" /></div>
                <div class="notice" style="float:left; line-height:21px; margin-left:15px">
                    <p>
