...
<div class="theme-blue"><?php echo $this->fetch('top.html'); ?></div>
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 class="page-title">消息队列管理</h1>
                    <ul class="breadcrumb">
            <li><a href="index.html">管理中心</a> </li>
            <li class="active">队列列表</li>
        </ul>
...
<div class="btn-toolbar list-toolbar">
    <form class="form-inline" id="formval" action="<?php echo $this->_var['webadmin']; ?>?ctl=sms_list" method="post">
...
<th>ID</th>
<th><a href="javascript:sortBy('send_type','1','PaymentOther','index')">发送类型</a></th>
<th><a href="javascript:sortBy('dest','1','PaymentOther','index')">接收人</a></th>
<th><a href="javascript:sortBy('user_id','1','PaymentOther','index')">会员名称</a></th>
<th><a href="javascript:sortBy('title','1','PaymentOther','index')">标题	</a></th>
<th><a>内容</a></th>
<th><a href="javascript:sortBy('create_time','1','PaymentOther','index')">创建时间	</a></th>
<th><a href="javascript:sortBy('send_time','1','PaymentOther','index')">发送时间	</a></th>
<th><a href="javascript:sortBy('is_success','1','PaymentOther','index')">结果</a></th>
<th><a href="javascript:sortBy('result','1','PaymentOther','index')">信息</a></th>
<th><a>操作</a></th>
</tr>
</thead>
<tbody>
...
<td align="center"><?php if (! $this->_var['item']['send_type']): ?>短信<?php else: ?>邮件<?php endif; ?></td>
<td align="center"><?php echo $this->_var['item']['dest']; ?></td>
<td align="center"><?php echo $this->_var['item']['user_name']; ?></td>
<td align="center"><?php echo $this->_var['item']['title']; ?></td>
<td align="center"><a title="查看" href="javascript:void(0);" onClick="show_content(<?php echo $this->_var['item']['id']; ?>)">查看</a></td>
<td align="center"><?php 
$k = array (
  'name' => 'to_date',
...
$k = array (
  'name' => 'to_date',
  'v' => $this->_var['item']['send_time'],
);
echo $k['name']($k['v']);
?></td>
<td align="center"><?php if ($this->_var['item']['is_success']): ?>成功<?php else: ?><font color="#FF0000">失败</font><?php endif; ?></td>
<td align="center"><?php echo $this->_var['item']['result']; ?></td>
<td align="center">
          <a href="javascript:send('<?php echo $this->_var['item']['id']; ?>')" title="编辑">发送</a>
          <a href="javascript:del(<?php echo $this->_var['item']['id']; ?>);" role="button" data-toggle="modal" title="删除">删除</a>
      </td>
</tr>
...
function show_content(id)
{
	...
	$.ajax({ 
				url: "/<?php echo $this->_var['webadmin']; ?>?ctl=sms_list&act=show_content&id="+id, 
				data: "ajax=1",
				dataType: "json",
...
{
	$.ajax({ 
			url: "/<?php echo $this->_var['webadmin']; ?>?ctl=sms_list&act=send&id="+id, 
			data: "ajax=1",
			dataType: "json",
			success: function(obj){
...
function delsel(paramobj)
{
	...
	dialog({title:"提示",content:'确定要删除选定项目吗?',okValue:"确定",ok:function(){
		...
		$.ajax({ 
				url: "/<?php echo $this->_var['webadmin']; ?>?ctl=company&act=foreverdelete&id="+id, 
				data: "ajax=1",
				dataType: "json",
				success: function(obj){
					if(obj.status==1)
...
function del(id){
	dialog({title:"提示",content:'确定要删除吗?',okValue:"确定",ok:function(){
		...
		$.ajax({ 
				url: "/<?php echo $this->_var['webadmin']; ?>?ctl=sms_list&act=foreverdelete&id="+id, 
				data: "ajax=1",
				dataType: "json",
				success: function(obj){
					if(obj.status==1)
