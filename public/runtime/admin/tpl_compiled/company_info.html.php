...
<ul class="nav nav-tabs">
  <li class="active"><a href="#home" data-toggle="tab">信息<?php if ($this->_var['id']): ?>编辑<?php else: ?>添加<?php endif; ?></a></li>
</ul>
...
<div class="row">
  <div class="col-md-4" style="width: 80%;">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form id="formval" action="<?php echo $this->_var['webadmin']; ?>?ctl=company&act=<?php if ($this->_var['vo']['id']): ?>update<?php else: ?>insert<?php endif; ?>" method="post">
