   ...
   private function get_page_link($url,$page)
    {
    	if(app_conf("URL_MODEL")==1)
    	{
    		...
    		//$url.=$page.'html';
    		//else
    		//$url.=$_GET['ctl']."/".$page.'.html';
			//$_GET['ctl']
			//if($_GET['ctl'])
			//$url=$url."/".$page.'.html';
			//if($_GET['ctl']) $url=$_GET['ctl']."/".$page.'.html';
			if($_GET['ctl']) $url = "/".$_GET['ctl']."/".$page.'.html';
			if($_GET['act']) $url = "/".$_GET['ctl']."/".$_GET['act']."/".$page.'.html';
			if($_GET['act']&&$_GET['id']) $url="/".$_GET['ctl']."/".$_GET['act']."/".$_GET['id']."/".$page.'.html';
